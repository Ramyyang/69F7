...
python pred.py \
	...
	--output_path ./pred_questions/agnews/SECURE_reg1_p_0.1.jsonl \
...
python eval_sentiment.py \
	...
	--input_path ./pred_questions/agnews/SECURE_reg1_p_0.1.jsonl \
	--output_path ./pred_sentiment/agnews/SECURE_reg1_p_0.1.json