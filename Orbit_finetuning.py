...
def main(**kwargs):
    ...
    safe_config = SafeLoRAConfig(
        base_model_path='ckpts/Llama-2-7b-hf',
        aligned_model_path='ckpts/Llama-2-7b-chat-fp16',
    ...
    if train_config.use_peft:
        ...
        safelora = SafeLoRA(model, safe_config)
        project_matrix = safelora.get_aligned_matrix()
        model.print_trainable_parameters()
    else:
        project_matrix = None  # if not using LoRA, set to None
